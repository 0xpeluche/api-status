...
function getRpcAggWorkerEndpoints() {
  ...
  let evmChains = ['ethereum', 'arbitrum', 'optimism', 'base', 'polygon', 'bsc', 'avax', 'fantom', 'sonic', 'era', 'polygon_zkevm', 'linea', 'xdai', 'klaytn', 'celo', 'scroll', 'aurora', 'unichain', 'plasma', 'monad', 'hyperliquid', 'berachain', 'wc', 'megaeth', 'ink']
...
function getJenApiV2() {
  ...
  return {
    ...
    endpoints: [
      ...
      { job: 'dimensions/job/(dimensions) pull data v3 - aggregators', time: 2 * HOUR, runTimeMin: 5 * MINUTE },
      { job: 'dimensions/job/(dimensions) pull data v3 - derivatives', time: 2 * HOUR },
      { job: 'dimensions/job/(dimensions) pull data v3 - dexs', time: 2 * HOUR, runTimeMin: 5 * MINUTE },
      { job: 'dimensions/job/(dimensions) pull data v3 - fees', time: 2 * HOUR, runTimeMin: 5 * MINUTE },
      { job: 'dimensions/job/(dimensions) pull data v3 - open-interest', time: 2 * HOUR },
      { job: 'dimensions/job/(dimensions) pull data v3 - options', time: 2 * HOUR },
      { job: 'dimensions/job/(dimensions) pull data v3 - rest', time: 2 * HOUR, runTimeMin: 5 * MINUTE },
